...
execute at @s[type=interaction,distance=..5,tag=ps_xian] run particle fishing ~ ~0.2 ~ 0.1 0 0.1 0 10
execute at @s[type=interaction,distance=..5,tag=ps_xian] run playsound item.bottle.empty block @a ~ ~ ~ 0.5 1
