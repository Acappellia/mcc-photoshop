...
setblock 0 -64 0 white_shulker_box{Items:[{id:"paper",count:1,Slot:0b,components:{item_name:'"正在处理的相纸"',lore:['[{"text":"放进显影液里浸泡，显现图案","color":"gray"}]'],max_stack_size:1,custom_model_data:1001}}]}
