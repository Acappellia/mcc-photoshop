...
data modify block 0 -64 0 Items[{Slot:0b}] merge from storage ps:game unlocks.outfit.0.item
data modify block 0 -64 0 Items[{Slot:1b}] merge from storage ps:game unlocks.outfit.1.item
data modify block 0 -64 0 Items[{Slot:2b}] merge from storage ps:game unlocks.outfit.2.item
data modify block 0 -64 0 Items[{Slot:3b}] merge from storage ps:game unlocks.outfit.3.item
data modify block 0 -64 0 Items[{Slot:4b}] merge from storage ps:game unlocks.outfit.4.item
data modify block 0 -64 0 Items[{Slot:5b}] merge from storage ps:game unlocks.outfit.5.item
data modify block 0 -64 0 Items[{Slot:6b}] merge from storage ps:game unlocks.outfit.6.item
data modify block 0 -64 0 Items[{Slot:7b}] merge from storage ps:game unlocks.outfit.7.item
