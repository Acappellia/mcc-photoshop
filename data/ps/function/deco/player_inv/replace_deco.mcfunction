...
data modify block 0 -64 0 Items[{Slot:3b}] merge from storage ps:game unlocks.deco.3.item
data modify block 0 -64 0 Items[{Slot:4b}] merge from storage ps:game unlocks.deco.4.item
data modify block 0 -64 0 Items[{Slot:5b}] merge from storage ps:game unlocks.deco.5.item
data modify block 0 -64 0 Items[{Slot:6b}] merge from storage ps:game unlocks.deco.6.item
data modify block 0 -64 0 Items[{Slot:7b}] merge from storage ps:game unlocks.deco.7.item
