advancement revoke @s only ps:attack_wallphoto
...
#execute
execute as @n[distance=..5,type=interaction,tag=photo_target,tag=ps_wall_photo,limit=1] at @s run function ps:photowall/remove